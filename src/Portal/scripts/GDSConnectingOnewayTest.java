...
public class GDSConnectingOnewayTest extends Login {
	@Test
	public void OnewayGDSConnectingFlight() throws Exception {
		...
		fp.preferredAirlineselect(ExcelUtils.readData("sheet3", 2, 1));
